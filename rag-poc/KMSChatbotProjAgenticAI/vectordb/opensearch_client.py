# =============================================================================
# vectordb/opensearch_client.py
# =============================================================================
# WHY THIS FILE EXISTS:
# This is the ONLY file that talks to AWS OpenSearch and AWS Bedrock
# (Titan Embeddings). It lives in its own top-level `vectordb/` package
# (a sibling of `app/`) since it's specifically "the vector database
# integration", separate from the rest of the application.
#
